...
//            [self.calloutView addSubview:btn];
            ...
            UILabel *name = [[UILabel alloc] initWithFrame:CGRectMake(0,
                                                                       kVertMargin,
                                                                       kCalloutWidth,
                                                                       (kCalloutHeight - 2 * kVertMargin)/2)];
            name.backgroundColor  = [UIColor clearColor];
            name.textAlignment    = NSTextAlignmentCenter;
            name.textColor        = [UIColor whiteColor];
            name.font             = [UIFont systemFontOfSize:15.f];
            name.text = self.name;
            [self.calloutView addSubview:name];
            UILabel *detailLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, (kCalloutHeight - 2 * kVertMargin)/2 + kVertMargin, kCalloutWidth, (kHeight - 2 * kVertMargin)/2)];
            detailLabel.backgroundColor  = [UIColor clearColor];
            detailLabel.textAlignment    = NSTextAlignmentCenter;
            detailLabel.textColor        = [UIColor whiteColor];
            detailLabel.font             = [UIFont systemFontOfSize:12.f];
            detailLabel.text = self.detailName;
            [self.calloutView addSubview:detailLabel];
...
- (id)initWithAnnotation:(id<MAAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(0,
                                                                   ...
                                                                   (kHeight - 2 * kVertMargin)/2)];
        self.nameLabel.backgroundColor  = [UIColor clearColor];
        self.nameLabel.textAlignment    = NSTextAlignmentCenter;
        self.nameLabel.textColor        = [UIColor whiteColor];
        self.nameLabel.font             = [UIFont systemFontOfSize:15.f];
        [self addSubview:self.nameLabel];
        self.detailLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, kVertMargin + (kHeight - 2 * kVertMargin)/2, kWidth - kPortraitWidth - kHoriMargin, (kHeight - 2 * kVertMargin)/2)];
